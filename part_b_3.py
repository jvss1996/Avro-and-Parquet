...
inverted8 = spark.read.format("com.databricks.spark.avro").load("/bigd45/out306/part-00000-9a78f365-fc6e-4de9-aa38-25d448fa139a-c000.avro")
...
sim_rdd5.coalesce(1).write.format("com.databricks.spark.avro").save("/bigd45/out333")